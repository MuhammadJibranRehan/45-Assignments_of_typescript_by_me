// // // Q17Shrinking Guest List: You just found out that your new dinner table won’t
//  arrive in time for the dinner, and you have space for only two guests.
var Guestlist = ["saba", "Rida"];
var Highlight = ("we cant arrange a bigger table");
var removeguest = ["Ali", "Saad", "M.jibran"];
...
var places = ["Bahawalpur", "Faisalabad", "Karachi", "Dubai", "Afghanistan"];
